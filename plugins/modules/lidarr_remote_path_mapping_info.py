...
DOCUMENTATION = r'''
---
module: lidarr_remote_path_mapping_info

short_description: Get information about Lidarr remote path mapping.

version_added: "1.0.0"

description: Get information about Lidarr remote path mapping.
