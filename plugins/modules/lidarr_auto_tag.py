...
DOCUMENTATION = r'''
---
module: lidarr_auto_tag

short_description: Manages Lidarr auto tag.

version_added: "1.0.0"

description: Manages Lidarr auto tag.
...
- name: Create a auto tag
  devopsarr.lidarr.lidarr_auto_tag:
    ...
    specifications:
    - name: "anime"
      implementation: "MusicTypeSpecification"
      negate: false
      required: true
      fields:
      - name: "value"
...
from ansible_collections.devopsarr.lidarr.plugins.module_utils.lidarr_specification_utils import SpecificationHelper
...
def run_module():
    ...
    # Set wanted resource.
    want = lidarr.AutoTaggingResource(
