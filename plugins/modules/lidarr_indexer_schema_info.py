...
DOCUMENTATION = r'''
---
module: lidarr_indexer_schema_info

short_description: Get information about Lidarr indexer schema.

version_added: "1.0.0"

description: Get information about Lidarr indexer schema.
...
def run_module():
    ...
    client = lidarr.IndexerApi(module.api)
    result = dict(
        changed=False,
        indexers=[],
    )
