...
DOCUMENTATION = r'''
---
module: lidarr_download_client_schema_info

short_description: Get information about Lidarr download client schema.

version_added: "1.0.0"

description: Get information about Lidarr download client schema.
...
def run_module():
    ...
    client = lidarr.DownloadClientApi(module.api)
    result = dict(
        changed=False,
        download_clients=[],
    )
