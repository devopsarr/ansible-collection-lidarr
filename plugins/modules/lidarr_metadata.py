...
DOCUMENTATION = r'''
---
module: lidarr_metadata

short_description: Manages Lidarr metadata.

version_added: "1.0.0"

description: Manages Lidarr metadata.
...
config_contract:
    ...
    returned: always
    type: str
    sample: "RoksboxMetadataSettings"
implementation:
    description: Implementation.
    returned: always
    type: str
    sample: "RoksboxMetadata"
tags:
...
def run_module():
    ...
    client = lidarr.MetadataApi(module.api)
    result = dict(
        changed=False,
        id=0,
    )
