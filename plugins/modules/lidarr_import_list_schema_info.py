...
DOCUMENTATION = r'''
---
module: lidarr_import_list_schema_info

short_description: Get information about Lidarr import list schema.

version_added: "1.0.0"

description: Get information about Lidarr import list schema.
