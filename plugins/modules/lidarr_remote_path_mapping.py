...
DOCUMENTATION = r'''
---
module: lidarr_remote_path_mapping

short_description: Manages Lidarr remote path mapping.

version_added: "1.0.0"

description: Manages Lidarr remote path mapping.
...
def run_module():
    ...
    client = lidarr.RemotePathMappingApi(module.api)
    result = dict(
        changed=False,
        id=0,
    )
    ...
    # Set wanted resource.
    want = lidarr.RemotePathMappingResource(
