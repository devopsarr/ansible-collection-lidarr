...
DOCUMENTATION = r'''
---
module: lidarr_auto_tag_schema_info

short_description: Get information about Lidarr auto tag schema.

version_added: "1.0.0"

description: Get information about Lidarr auto tag schema.
