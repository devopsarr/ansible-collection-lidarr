...
DOCUMENTATION = r'''
---
module: lidarr_download_client

short_description: Manages Lidarr download client.

version_added: "1.0.0"

description: Manages Lidarr download client.
...
def run_module():
    ...
    # Set wanted resource.
    want = lidarr.DownloadClientResource(
