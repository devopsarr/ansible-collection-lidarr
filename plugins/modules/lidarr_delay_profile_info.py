...
DOCUMENTATION = r'''
---
module: lidarr_delay_profile_info

short_description: Get information about Lidarr delay profile.

version_added: "1.0.0"

description: Get information about Lidarr delay profile.
...
def run_module():
    ...
    client = lidarr.DelayProfileApi(module.api)
    result = dict(
        changed=False,
        delay_profiles=[],
    )
