...
DOCUMENTATION = r'''
---
module: lidarr_quality

short_description: Manages Lidarr quality.

version_added: "1.0.0"

description: Manages Lidarr quality.
...
def run_module():
    ...
    # No delete is needed
    want = lidarr.QualityDefinitionResource(
    ...
    want.quality = lidarr.Quality(**result['quality'])
    if want != state:
